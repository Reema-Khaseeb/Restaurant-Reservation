...
namespace RestaurantReservation.Db
{
    public class RestaurantReservationDbContext : DbContext
    {
        ...
        public DbSet<EmployeeWithRestaurantDetailsView> EmployeesWithRestaurantDetailsViews { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EmployeeWithRestaurantDetailsView>().HasNoKey().ToView("EmployeeWithRestaurantDetailsView");
